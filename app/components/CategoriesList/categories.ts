...
const BASE_CATEGORIES = [
  {
    name: 'Spożywcze',
    icon: 'faUtensils',
    color: 'Red' as keyof typeof COLORS_MAP,
  },
  {
    name: 'Elektronika',
    icon: 'faTv',
    color: 'Blue' as keyof typeof COLORS_MAP,
  },
  {
    name: 'Odzież',
    icon: 'faTshirt',
    color: 'Green' as keyof typeof COLORS_MAP,
  },
  {
    name: 'Kosmetyki',
    icon: 'faPumpSoap',
    color: 'Pink' as keyof typeof COLORS_MAP,
  },
  { name: 'Dom', icon: 'faCouch', color: 'Yellow' as keyof typeof COLORS_MAP },
  {
    name: 'Rozrywka',
    icon: 'faGamepad',
    color: 'Orange' as keyof typeof COLORS_MAP,
  },
  {
    name: 'Jedzenie',
    icon: 'faHamburger',
  ...
  },
  {
    name: 'Hobby',
    icon: 'faPalette',
    color: 'Yellow' as keyof typeof COLORS_MAP,
  },
  {
    name: 'Inne',
    icon: 'faQuestion',
